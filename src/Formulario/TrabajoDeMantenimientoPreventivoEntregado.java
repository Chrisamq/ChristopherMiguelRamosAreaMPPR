...
public class TrabajoDeMantenimientoPreventivoEntregado extends javax.swing.JDialog {

    public TrabajoDeMantenimientoPreventivoEntregado(java.awt.Frame parent, boolean modal) throws Exception {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
      
    }
      public TrabajoDeMantenimientoPreventivoEntregado(){
      initComponents();
    }
    ...
    private void initComponents() {
        ...
        labelHeader1.setText("Preventivos entregados");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Trabajos de mantenimiento preventivo entregados", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(153, 153, 153))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "OTM", "OTG", "Tipo", "Fecha de entrega", "Entrega", "Recibe", "Key"
            }
        ));
        ...
        jLabel63.setText("Listado de trabajos de mantenimiento preventivo entregados");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrabajoDeMantenimientoPreventivoEntregado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TrabajoDeMantenimientoPreventivoEntregado dialog = null;
                try {
                    dialog = new TrabajoDeMantenimientoPreventivoEntregado(new javax.swing.JFrame(), true);
                } catch (Exception ex) {
                    Logger.getLogger(TrabajoDeMantenimientoPreventivoEntregado.class.getName()).log(Level.SEVERE, null, ex);
                }
